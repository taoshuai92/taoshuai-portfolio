...
const staticFiles = [
  ...
  "assets/images/ai-agent-slices/ai-agent-opening-top.webp",
  "assets/images/ai-agent-slices/ai-agent-opening-architecture.webp",
  ...
  "assets/images/ai-agent-html/agent-zero-entry.webp",
  "assets/images/ai-agent-html/stage-1-silent.png",
  "assets/images/ai-agent-html/stage-2-agent.png",
  "assets/images/ai-agent-html/stage-3-homeclaw.png",
  "assets/images/ai-agent-html/desktop-1-0.webp",
  "assets/images/ai-agent-html/desktop-2-0.webp",
  "assets/images/ai-agent-html/perception-inspection-settings.webp",
  "assets/images/ai-agent-html/perception-sleep-report.webp",
